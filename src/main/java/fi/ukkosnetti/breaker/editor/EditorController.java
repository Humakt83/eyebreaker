...
import fi.ukkosnetti.breaker.game.level.BlackBox;
import fi.ukkosnetti.breaker.game.level.BlueBox;
import fi.ukkosnetti.breaker.game.level.Box;
import fi.ukkosnetti.breaker.game.level.GoldBox;
import fi.ukkosnetti.breaker.game.level.GreenBox;
import fi.ukkosnetti.breaker.game.level.GreyBox;
import fi.ukkosnetti.breaker.game.level.OrangeBox;
import fi.ukkosnetti.breaker.game.level.PinkBox;
import fi.ukkosnetti.breaker.game.level.RedBox;
import fi.ukkosnetti.breaker.game.level.TealBox;
import fi.ukkosnetti.breaker.game.level.VioletBox;
import fi.ukkosnetti.breaker.game.level.WhiteBox;
import fi.ukkosnetti.breaker.game.level.YellowBox;
